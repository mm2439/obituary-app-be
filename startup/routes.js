...
const notification = require("../routers/notification.route");
const gift = require("../routers/gift.route");
const activityLog = require("../routers/activityLog.route");
const commonSupabase = require("../routers/common.supabase.route");
...
module.exports = (app) => {
  ...
  app.use("/api/common-supabase", commonSupabase);
  app.use(error);
};
